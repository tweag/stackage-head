...
SITE_DIR=test-site
FLAKY_PKGS="--flaky threads --flaky lifted-async --flaky stm-delay"
...
stack exec stackage-head -- generate-site --site-dir $SITE_DIR $FLAKY_PKGS --outdir $BUILD_REPORTS_DIR
